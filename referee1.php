        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <table>
              ...
              <td><input id="date2" type="date" size="5" name="refend" class="form-control" readonly>
                <script>
                function myFunction() {;
              ...
              <div class="modal-dialog" role="document">
                ...
                <form action="editref2.php?id=<?php echo $objResult["ref_id"];?>" method="post">
                  <table>
                          ...
                          <tr>
                          <td>วันที่เริ่มวาระ<font color="red">* &nbsp;</font></td>
                          <td><input type="date" value="<?php echo $objResult["start_date"];?>" size="5" name="refstart" class="form-control"></td>
                          </tr>
                          <tr>
                          <td>วันที่หมดวาระ<font color="red">* &nbsp;</font></td>
                          <td><input type="date" value="<?php echo $objResult["end_date"];?>" size="5" name="refend" class="form-control"</td>
                          </tr>
                           </table>
                ...
                <div class="modal-content">
                  ...
                  <center>
                      ...
                      ?></td>
                          ...
                          <tr>
                            <td>วันที่หมดวาระ</td>
                            <td><?php echo date("d/m/Y", strtotime($objResult["end_date"]));?></td>
                          </tr>
                      </table>
                    </center>
                  </div>
