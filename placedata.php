...
<link rel="shortcut icon" type="image/x-icon" href="pic/icon.ico">
  <head>
    ...
    <title>รายการบันทึกขอใช้สถานที่</title>
...
?><br>
        <center> <h3>รายการบันทึกขอใช้สถานที่</h3>
        <table>
          <tr>
            <form class="" action="placedata.php" method="post">
        ...
        ?>
             <div class="container">
              ...
              $objConnect = mysql_connect("localhost","root","12345678") or die("Error Connect to Database");
                ...
                $strSQL = "SELECT * FROM place re,member mem where re.member_id = mem.member_id and (mem.m_firstname like '%".$search."%' or mem.m_lastname like '%".$search."%') ";
...
$strSQL .=" order by place_id DESC LIMIT $Page_Start , $Per_Page";
...
$offset=($Page-1)*$Per_Page; // ตรงนี้สำคัญครับ
              ...
              <tr class="text-dark bg-white">
                ...
                <td align="center"><?php echo $id2 = $objResult["place_id"];?></td>
                <td><?php
                    $host = "localhost";
                    $user = "root";
                    $pass = "12345678";
                ...
                ?></td>
                <td align="left"><?php echo $objResult["place_name"];?></td>
                <td align="left"><?php echo $objResult["place_topic_name"]; ?> </td>
              ...
              <?}?>
                ...
                <td><a href="#detail<?php echo $objResult["place_id"];?>" data-toggle="modal">
                  <!-- Button trigger modal -->
                <button type="button" class="btn btn-info view_data" value="รายละเอียด">
                <i class="fas fa-info-circle"> รายละเอียด</i>
                </button></a>
                <!-- Modal -->
                <div class="modal fade bd-example-modal-lg" id="detail<?php echo $objResult["place_id"];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    ...
                    <div class="modal-content">
                      ...
                      <center>
                        <table class="">
                          ...
                          <tr>
                            <td align="center"><?php echo $objResult["place_detail"];?></td>
                          </tr>
                        </table>
