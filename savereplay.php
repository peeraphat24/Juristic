    	  ...
    	  <div class="bg-card">
            ...
            <? }?>
               ...
               <?php
                 ...
                 $sql2 = "select * from reply where member_id = '".$_SESSION["member_id"]."' order by reply_id DESC";
               ...
               <tr align="center" class="text-dark bg-white">
                 ...
                 <td align="left"><?php if ($rs2["member_id"] == $name_check) {
                       echo $show["m_firstname"]; echo " "; echo $show["m_lastname"];}?></td>
                 ...
                 <!-- Modal -->
                 <div class="modal fade" id="detail<?php echo $rs2["reply_id"];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                   <div class="modal-dialog" role="document">
                     <div class="modal-content">
                       ...
                       <center>
                               <table>
                               <tr>
                                 <td align="left"><?php echo $rs2["re_detail"];?></td>
                               </tr>
                           </table>
                         </center>
                       </div>
