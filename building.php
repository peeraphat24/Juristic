...
<head>
    ...
    <title>บันทึกแบบขอต่อเติมอาคาร</title>
                                    ...
                                    <div class="panel panel-info">
                                        <div class="panel-heading">
                                            <div class="alert alert-primary" role="alert">
                                                บันทึกแบบขอต่อเติมอาคาร
                                            </div>
                                        </div>
                </center>
                <div class="panel-body">
                    <form enctype="multipart/form-data" action="insertbuild.php" method="post">
                    ...
                    ?>
                            ...
                            <div class="form-row">
                                <div class="col-md">
                                เลขบัตรประชาชน<font color="red">*</font>
                                <input type="text" name="mid" class="form-control" maxlength="13" value="<?php  echo $rs['identify_id'] ?>">
                                </div>
                                <div class="col-md">
                                    เบอร์โทรศัพท์<font color="red">*</font>
                                    <input type="text" name="telephone" maxlength="10" class="form-control" value="<?php  echo $rs['m_tel'] ?>">
                                </div>
                                <div class="col-md"> <br>
                                    <input type="checkbox"> 1111111111111111
                                    <input type="checkbox"> 2222222222222222
                                    <input type="checkbox"> 3333333333333333
                                </div>
                            </div>
                            <br>
                            <div class="form-row">
                            ...
                            <center>
                                <div class="form-row">
                                    <div class="col-md">
                                        <button type="submit" value="บันทึก" class="btn btn-success" name="submit"><i
                                                class="far fa-save"></i> บันทึก</button>
                                        &nbsp;
                                        <button type="reset" value="ล้าง" class="btn btn-danger" name="reset"><i
                                                class="fas fa-eraser"></i> ล้างข้อความ</button>
                                    </div>
                    </form>
                    <? }?>
                </div>
